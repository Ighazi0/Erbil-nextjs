...
export default function ModalRentDuration({ isOpen, onClose, pricePerDay, car }) {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            myHeaders.append("Authorization", "Token are_sk_test_26dcdb8d82f6d70cc271672c5f60faa709d1020b50710531d3d4ad9ab193fd79");
            ...
            // await onConfirm(days, localStartDate);
            // setToastType('success');
            // setToastMessage('Rental order created successfully!');
            // setShowToast(true);
            // setTimeout(() => {
            //     onClose();
            // }, 1500);
