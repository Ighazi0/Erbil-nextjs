              ...
              <div className="contact-us">
                <div className="row mb-60">
                  <div className="col-md-12 col-lg-6">
                    <div className="contact-us-box w-100">
                      <div className="icon">
                        <svg
                          width={68}
                          height={70}
