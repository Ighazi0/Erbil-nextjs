                        ...
                        <div className="themesflat-container">
                            <div className="breakcrumb">
                                <div className="title-breakcrumb">
                                    <Link className="home" href="/"><FormattedMessage id="home" /></Link>
                                    <span><FormattedMessage id="Property Listing" /></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="wrap-property-car flex">
                                        <div className="box-1">
                                            <div className="i-box-info flex align-items-center">
                                                <div className="info flex">
                                                    <span><FormattedMessage id="brand" />{`:`}</span>
                                                    <span className="fw-4 mx-1"> {car.brand}</span>
                                                </div>
                                                <div className="info flex">
                                                    <span><FormattedMessage id="Model:" /></span>
                                        ...
                                        <div className="box-2 t-al-right">
                                            <div className="price-wrap flex">
                                                <p className="price-sale">{(car.price*rate).toFixed(1)} {code}</p>
                                            </div>
                                            <button
                                ...
                                <div className="col-md-10 col-12 mx-auto">
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            <h4 className="title"><FormattedMessage id="Description" /></h4>
                                            <p>{car.description}</p>
                                        </div>
                                        <div className="wrap-car-overview wrap-style">
                                            <h4 className="title"><FormattedMessage id="Car Overview" /></h4>
                                                ...
                                                <div className="row">
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Condition:" /></span>
                                                                <p className="listing-info-value">{car.condition}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Cylinders:" /></span>
                                                                <p className="listing-info-value">{car.cylinders}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Stock Number:" /></span>
                                                                <p className="listing-info-value">{car.stockNumber}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Fuel Type:" /></span>
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="VIN Number:" /></span>
                                                                <p className="listing-info-value">{car.vinNumber}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Doors:" /></span>
                                                                <p className="listing-info-value">{car.doors}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Year:" /></span>
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Color:" /></span>
                                                                <p className="listing-info-value" style={{
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Mileage:" /></span>
                                                                <p className="listing-info-value">{car.mileage}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Seats:" /></span>
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Transmission:" /></span>
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="City MPG:" /></span>
                                                                <p className="listing-info-value">{car.cityMpg}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Engine Size:" /></span>
                                                                <p className="listing-info-value">{car.engineSize} L</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Highway MPG:" /></span>
                                                                <p className="listing-info-value">{car.highwayMpg}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                <span className="listing-info-title"><FormattedMessage id="Driver Type:" /></span>
                                                                <p className="listing-info-value">{car.driverType}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="wrap-car-feature wrap-style">
                                            <h4 className="title"><FormattedMessage id="Features" /></h4>
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    {car.features && Object.entries(car.features).map(([category, features]) => (
                                                        features.length > 0 && (
                                                            <div className="features-item" key={category}>
                                                                ...
                                                                {features.map((feature) => (
                                                                    <div className="listing-feature-wrap" key={feature}>
                                                                        <i className="icon-Vector-32" />
                                                                        <FormattedMessage id={feature} defaultMessage={feature.replace(/_/g, ' ')} />
                                                                    </div>
                                                                ))}
                                                            </div>
                                                        )
                    ...
                    <div className="widget-related-single-listing">
                        <div className="themesflat-container">
                            <div className="listing-list-car-grid ">
                                {listing.map(item => (<CarCard item={item} />))}
                            </div>
                        </div>
                    </div>
                </div>
