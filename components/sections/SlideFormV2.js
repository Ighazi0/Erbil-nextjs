              ...
              <div className="slider-wrap">
                <div className="slide-content">
                  <span className="sub-title">
                    <FormattedMessage id="Trusted Dealer, Rental" />
                  </span>
                  <h1>Erbil</h1>
                  <div className="btn-main">
                    <span className="main_button_circle"></span>
                ...
                <div className="slide-box-form">
                  ...
                  >
                    <option data-value={0} className="option">
                  ...
                  <div
                    className="tab-content form-v4-content"
                    id="pills-tabContent"
                  >
                    <div className="tab-pane fade show active">
                      ...
                      <div className="form-group btn-main w-100 mt-3">
                        <Link
                          href="/car-list"
                          type="submit"
                          className="button_main_inner w-100"
                        >
