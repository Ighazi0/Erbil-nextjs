            ...
            <div className="widget-car-list-v2-h5">
                <div className="themesflat-container">
                    <div className="header-tab mb-46">
                        ...
                        <ul className="nav nav-pills tab-car-service-v2 justify-content-end" role="tablist">
                            {types.map((t) => (
                                <li key={t.id} className="nav-item" onClick={() => handleOnClick(t.id)}>
                                    <button
                                        className={activeIndex === t.id ? "nav-link active" : "nav-link"}
                                    >
                                        {intl.locale === 'ar' ? t.name_ar : intl.locale === 'en' ? t.name_en : t.name_kr}
                                    </button>
                                </li>
                            ))}
                        </ul>
                                    ...
                                    <div key={car.id} className="col-12 col-sm-6 col-md-6 col-xl-6">
                                        <div className="tf-car-service-v2">
                                            ...
                                            <div className="content">
                                                <h6 className="title">
                                                    <Link href={`/car-details/${car.id}`}>{car.title}</Link>
                                                </h6>
                                                <div className="description">
                                                    <ul>
                                                        <li className="listing-information fuel">
                                                            ...
                                                            <div className="inner">
                                                                <span>
                                                                    <FormattedMessage id="fuelType" defaultMessage="Fuel Type" />
                                                                </span>
                                                                <p>{car.fuelType}</p>
                                                            </div>
                                                        </li>
                                                        <li className="listing-information size-engine">
                                                            ...
                                                            <div className="inner">
                                                                <span>
                                                                    <FormattedMessage id="mileage" defaultMessage="Mileage" />
                                                                </span>
                                                                <p>{car.mileage}</p>
                                                            </div>
                                                        </li>
