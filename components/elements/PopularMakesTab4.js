...
export default function PopularMakesTab4() {
  ...
  return (
    <>
      <ul
        className="nav nav-pills tab-car-service-v2 justify-content-center mb-30"
      ...
      <div className="tab-content" id="pills-tabContent-v2">
          ...
          <div className="car-list-item">
            <div className="tf-car-service">
                    ...
                    <div className="wrap-hover-listing">
                      ...
                      >
                        <div className="images">
                          <img
                            src="./assets/images/car-list/car22.jpg"
              ...
              <div className="content">
                ...
                <h6 className="title">
                  <a href="#" />
                  <a href="#">Chevrolet Suburban 2021 mo</a>
                </h6>
                  ...
                  <div className="hover-listing-image">
                    <div className="wrap-hover-listing">
                      ...
                      >
                        <div className="images">
                          <img
                            src="./assets/images/car-list/car20.jpg"
                            className="swiper-image tfcl-light-gallery"
                            alt="images"
                          />
                        </div>
        ...
        <div
          className={
            activeIndex == 5 ? "tab-pane fade show active" : "tab-pane fade"
          }
        >
          <div className="car-list-item">
            <div className="tf-car-service">
