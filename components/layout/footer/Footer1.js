...
export default function Footer1() {
  ...
  return (
    <>
      <footer id="footer" className="clearfix bg-primary ">
        <div className="themesflat-container">
          <div className="row footer-main">
            ...
            <div className="col-lg-3 col-md-4 col-12">
              <div className="widget widget-menu pl-60">
                <h3>
                  <FormattedMessage id="Driving In UAE" />
                </h3>
                <ul className="box-menu">
                  <li>
                    <Link href="/driving-in/uae">
                      <FormattedMessage id="uae" />
                    </Link>
                  </li>
                  <li>
                    <Link href="/driving-in/dubai">
                      <FormattedMessage id="dubai" />
                    </Link>
                  </li>
                  <li>
                    <Link href="/driving-in/abu-dhabi">
                      <FormattedMessage id="abuDhabi" />
                    </Link>
                  </li>
                  <li>
                    <Link href="/driving-in/sharjah">
                      <FormattedMessage id="sharjah" />
                    </Link>
                  </li>
                  <li>
                    <Link href="/driving-in/ras-al-khaimah">
                      <FormattedMessage id="rasAlKhamiah" />
                    </Link>
                  </li>
                </ul>
              </div>
                  ...
                  <li className="d-flex align-items-center">
                    <Link href="https://maps.app.goo.gl/dkW7BCjLpTAMzGfa9?g_st=com.google.maps.preview.copy">
                      ...
                      >
                        ...
                        BG04, Enoc 33, Auto center, Behind Al Habtoor Motor
                        Deira, Dubai, UAE
                      </p>
                    </Link>
                  </li>
