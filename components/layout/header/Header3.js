...
export default function Header3({
    scroll, isMobileMenu, handleMobileMenu, handleToggle1, isToggled1,
    handleToggle2, isToggled2, handleToggle3, isToggled3
}) {
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                <ul className="icon-topbar">
                                    <li>
                                        <a href="https://facebook.com/alqassim.cars"><FaFacebookF className="text-white icon_over" /></a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/alqassim_cars"><FaTwitter className="text-white icon_over" /></a>
                                    </li>
                                    <li>
                                        <a href="https://instagram.com/alqassim.cars/"><FaInstagram className="text-white icon_over" /></a>
                                    </li>
                                    <li>
                                        <a href="https://youtube.com/channel/UC8ba_qHDE8-k6qXfIbk6Jew"><FaYoutube className="text-white icon_over" /></a>
                                    </li>
                                    <li>
                                        <a href="https://snapchat.com/add/alqassim.cars"><FaSnapchat className="text-white icon_over" /></a>
                                    </li>
                                    <li>
                                        <a href="https://t.me/alqassim_cars"><FaTelegramPlane className="text-white icon_over" /></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="themesflat-container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div
                                    className="header-style2 flex justify-space align-center">
                                    {/* Logo Box */}
                                    ...
                                    <div
                                        className={`mobile-nav-toggler mobile-button ${lang === 'ar' ? 'position-left' : 'position-right'}`}
                    ...
                    <nav className="menu-box">
                        ...
                        <div className="bottom-canvas">
                            ...
                            <div className="help-bar-mobie login-box">
                                <Link href="/login" role="button" className={` fw-7 category`}><i className="icon-user px-3" />< FormattedMessage id="login" /></Link>
                            </div>
                        </div>
                    </nav>
                </div>
